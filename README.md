[![Quality Gate Status](https://sonar.vitta.tools/api/project_badges/measure?project=nodejs-sample-app&metric=alert_status)](https://sonar.vitta.tools/dashboard?id=nodejs-sample-app) [![Coverage](https://sonar.vitta.tools/api/project_badges/measure?project=nodejs-sample-app&metric=coverage)](https://sonar.vitta.tools/dashboard?id=nodejs-sample-app)
